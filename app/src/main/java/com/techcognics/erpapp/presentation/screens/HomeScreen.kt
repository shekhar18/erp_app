...
fun HomeScreen(modifier: Modifier = Modifier, navController: NavHostController) {
    val stats = listOf(
        StatCard("Revenue", "₹50", "Cr", Color(0xFFFFCDD2), Color(0xFFFFEBEE), R.drawable.rad_chart),
        StatCard("Expected Revenue", "₹13", "Lakhs", Color(0xFFC8E6C9), Color(0xFFE8F5E9), R.drawable.green_chart),
        StatCard("Sales Orders", "₹12", "Lakhs", Color(0xFFD1C4E9), Color(0xFFEDE7F6), R.drawable.purple_chart),
        StatCard("All Values", "₹12", "Lakhs", Color(0xFFFFE0B2), Color(0xFFFFF3E0), R.drawable.yellow_chart)
    )
